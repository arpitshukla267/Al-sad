...
const Footer = () => {
  return (
    <footer className="w-full px-5 py-10 max-w-[1260px] mx-auto  h-[535px] sm:pt-[64px] sm:pb-[80px] sm:px-20">
      <div className="flex justify-between gap-8 sm:gap-24 h-full w-full flex-wrap sm:flex-nowrap">
        <div className="flex flex-col justify-between w-full items-start gap-5 sm:gap-0">
          ...
          <div className="flex items-center gap-3 sm:gap-10">
            <FaFacebookSquare className="border p-3 rounded-full size-12" />
            <LuInstagram className="border p-3 rounded-full size-12" />
            <PrimaryBtn
